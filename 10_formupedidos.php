        ...
        <form action= "10_inserta_pedidos.php" method = "post">
            <div class="form-group">
                <?php
                    ...
                    //Creo la sentencia
                    $consultar="SELECT tipo FROM panes";
            ...
            <div class="form-group">
                ...
                <input type ="number" class="form-control" name="cantidad" id="cantidad" placeholder="Introduzca un cantidad"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="fecha">Elige una fecha de pedido:</label>
